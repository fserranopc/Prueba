odoo.define('bi_website_portal_dashboard.portal_dashboard', function(require) {
	...
	$(document).ready(function() {
		if ($(".breadcrumb-item.active")[0]){
			...
			$(".dashboard_header_text_h").html('Mi cuenta');
		}
	});
	...
	function loadCharts(filter){
		var titles = [["Análisis de las ventas de hoy","Análisis de las facturas de hoy","Análisis de las compras de hoy","Análisis de los recibos de hoy"],
						["Análisis de las ventas de ayer","Análisis de las facturas de ayer","Análisis de las compras de ayer","Análisis de los recibos de ayer"],
						["Análisis de las ventas de la semana","Análisis de las facturas de la semana","Análisis de las compras de la semana","Análisis de los recibos de la semana"],
						["Análisis de las ventas del mes","Análisis de las facturas del mes","Análisis de las compras del mes","Análisis de los recibos del mes"],
						["Análisis de las ventas del año","Análisis de las facturas del año","Análisis de las compras del año","Análisis de los recibos del año"],];
	...
	function loadProductsCharts(filter){
		var prod_titles = [["Top 10 productos vendidos hoy","Top 10 productos comprados hoy"],
							["Top 10 productos vendidos de ayer","Top 10 productos comprados ayer"],
							["Top 10 productos vendidos de la semana","Top 10 productos comprados de la semana"],
							["Top 10 productos vendidos del mes","Top 10 productos comprados del mes"],
							["Top 10 productos vendidos del año","Top 10 productos comprados del año"],];
